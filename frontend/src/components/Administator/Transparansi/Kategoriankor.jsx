...
const Kategoriankor = () => {
  ...
  } = useSWR("https://api.desarandusangakulon.com/ankor", fetcher);
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://api.desarandusangakulon.com/kategoriankor/${currentKategoriAnkor.uuid}`,
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/ckategoriankor",
          { name: formData.name, ankorId: formData.ankorId },
          {
            headers: {
              "Content-Type": "application/json",
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/kategoriankor/${id}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
