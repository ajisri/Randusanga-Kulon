...
const Produkhukum = () => {
  ...
  const {
    ...
    "https://ds-randusanga-kulon.osc-fr1.scalingo.io/produk_hukum",
    fetcher
  );
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://ds-randusanga-kulon.osc-fr1.scalingo.io/produk_hukum/${currentProdukhukum.uuid}`,
          dataToSend,
          {
        ...
        await axiosJWT.post(
          "https://ds-randusanga-kulon.osc-fr1.scalingo.io/cprodukhukum",
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
  ...
  const editProdukhukum = (produkhukum) => {
    ...
    const fileUrl = produkhukum.file_url
      ? `https://ds-randusanga-kulon.osc-fr1.scalingo.io${produkhukum.file_url}`
      : null;
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://ds-randusanga-kulon.osc-fr1.scalingo.io/produk_hukum/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
