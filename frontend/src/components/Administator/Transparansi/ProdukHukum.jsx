...
const Produkhukum = () => {
  ...
  const {
    ...
    "https://api.desarandusangakulon.com/produk_hukum",
    fetcher
  );
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://api.desarandusangakulon.com/produk_hukum/${currentProdukhukum.uuid}`,
          dataToSend,
          {
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/cprodukhukum",
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
  ...
  const editProdukhukum = (produkhukum) => {
    ...
    const fileUrl = produkhukum.file_url
      ? `https://api.desarandusangakulon.com/${produkhukum.file_url}`
      : null;
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/produk_hukum/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
