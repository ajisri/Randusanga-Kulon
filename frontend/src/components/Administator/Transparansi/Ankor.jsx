    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://randusanga-kulon.osc-fr1.scalingo.io/ankor/${currentAnkor.id}`,
          { name: formData.name },
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://randusanga-kulon.osc-fr1.scalingo.io/cankor",
          { name: formData.name },
          {
            headers: {
              "Content-Type": "application/json",
      ...
      await mutate("https://randusanga-kulon.osc-fr1.scalingo.io/ankor");
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://randusanga-kulon.osc-fr1.scalingo.io/ankor/${id}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
