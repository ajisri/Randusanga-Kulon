    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://api.desarandusangakulon.com/ankor/${currentAnkor.id}`,
          { name: formData.name },
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/cankor",
          { name: formData.name },
          {
            headers: {
              "Content-Type": "application/json",
      ...
      await mutate("https://api.desarandusangakulon.com/ankor");
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/ankor/${id}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
