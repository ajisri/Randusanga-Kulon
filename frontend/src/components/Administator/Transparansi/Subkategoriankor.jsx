...
const SubkategoriAnkor = () => {
  ...
  const {
    ...
    "https://api.desarandusangakulon.com/subkategoriankor",
    fetcher
  );
  ...
  const {
    ...
    "https://api.desarandusangakulon.com/kategoriankor",
    fetcher
  );
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await axiosJWT.patch(
          `https://api.desarandusangakulon.com/subkategoriankor/${currentSubkategoriankor.uuid}`,
          dataToSend,
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/csubkategoriankor",
          dataToSend,
          {
            headers: {
              "Content-Type": "application/json",
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/subkategoriankor/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
  ...
  const handlePoinSubmit = async (e) => {
    ...
    try {
      ...
      setIsLoadingProcess(true);
      await axiosJWT.post(
        "https://api.desarandusangakulon.com/cpoinsubkategoriankor",
        {
  ...
  const fetchPoinBySubKategoriAnkorId = async (subkategoriankorId) => {
    try {
      ...
      const response = await axiosJWT.get(
        `https://api.desarandusangakulon.com/poinbysubkategoriankor/${subkategoriankorId}`
      );
