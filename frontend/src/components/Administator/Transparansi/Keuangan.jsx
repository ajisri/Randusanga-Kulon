...
const Keuangan = () => {
  ...
  const {
    ...
    "https://ds-randusanga-kulon.osc-fr1.scalingo.io/allapbd",
    fetcher
  );
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://ds-randusanga-kulon.osc-fr1.scalingo.io/keuangan/${currentKeuangan.uuid}`,
          dataToSend
        );
        toast.current.show({
          severity: "success",
        ...
        await axiosJWT.post(
          "https://ds-randusanga-kulon.osc-fr1.scalingo.io/ckeuangan",
          dataToSend
        );
        toast.current.show({
          severity: "success",
      ...
      await mutate("https://ds-randusanga-kulon.osc-fr1.scalingo.io/keuangan");
      resetForm();
      setDialogVisible(false);
    } catch (error) {
      handleError(error);
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      ...
      try {
        await axiosJWT.delete(
          `https://ds-randusanga-kulon.osc-fr1.scalingo.io/keuangan/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
    ...
    <div>
      ...
      >
        ...
        <Column
          field="name"
          header="Name"
          style={{ width: "60%", minWidth: "25%" }}
        />
        <Column
          field="apbdId"
          header="Nama dan Tahun Anggaran"
          style={{ width: "35%", minWidth: "20%" }}
          body={(rowData) => {
