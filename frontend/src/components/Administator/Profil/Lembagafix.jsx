...
const Lembaga = () => {
  ...
  const { data: anggotaData } = useSWR(
    "https://ds-randusanga-kulon.osc-fr1.scalingo.io/demografi", // Endpoint untuk mendapatkan anggota
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      mutate("https://ds-randusanga-kulon.osc-fr1.scalingo.io/lembaga"); // Re-fetch data lembaga
      toast.current.show({
        severity: "success",
        summary: "Berhasil",
