...
const Tentang = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://randusanga-kulon.osc-fr1.scalingo.io/tentang",
    fetcher
  );
  ...
  useEffect(() => {
    axiosJWT
      .get("https://randusanga-kulon.osc-fr1.scalingo.io/tentang")
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosJWT.post(
        "https://randusanga-kulon.osc-fr1.scalingo.io/ctentang",
        formData,
        {
          headers: {
      ...
      await mutate("https://randusanga-kulon.osc-fr1.scalingo.io/tentang");
