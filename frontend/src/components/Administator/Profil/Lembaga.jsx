...
const Lembaga = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://api.desarandusangakulon.com/lembaga",
    fetcher
  );
  ...
  const {
    ...
    "https://api.desarandusangakulon.com/demografi", // Endpoint API demografi
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await axiosJWT.put(
          `https://api.desarandusangakulon.com/ulembaga/${currentData.uuid}`,
          data,
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/clembaga",
          data,
          {
            headers: {
              "Content-Type": "multipart/form-data",
      ...
      await mutate("https://api.desarandusangakulon.com/lembaga");
      resetForm();
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/lembaga/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
  ...
  const openEditDialog = (rowData) => {
    ...
    if (typeof rowData.file_url === "string") {
      const fullUrl = `https://api.desarandusangakulon.com/${rowData.file_url}`;
