...
const Lembaga = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://ds-randusanga-kulon.osc-fr1.scalingo.io/lembaga",
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await axiosJWT.put(
          `https://ds-randusanga-kulon.osc-fr1.scalingo.io/ulembaga/${currentData.uuid}`,
          data,
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://ds-randusanga-kulon.osc-fr1.scalingo.io/clembaga",
          data,
          {
            headers: {
              "Content-Type": "multipart/form-data",
      ...
      await mutate("https://ds-randusanga-kulon.osc-fr1.scalingo.io/lembaga");
      resetForm();
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://ds-randusanga-kulon.osc-fr1.scalingo.io/lembaga/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
  ...
  const openEditDialog = (rowData) => {
    ...
    if (typeof rowData.file_url === "string") {
      const fullUrl = `https://ds-randusanga-kulon.osc-fr1.scalingo.io/${rowData.file_url}`;
