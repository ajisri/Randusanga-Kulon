...
const Lembaga = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://randusanga-kulonbackend-production-fa8c.up.railway.app/lembaga",
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await axiosJWT.put(
          `https://randusanga-kulonbackend-production-fa8c.up.railway.app/ulembaga/${currentData.uuid}`,
          data,
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://randusanga-kulonbackend-production-fa8c.up.railway.app/clembaga",
          data,
          {
            headers: {
              "Content-Type": "multipart/form-data",
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://randusanga-kulonbackend-production-fa8c.up.railway.app/lembaga/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
  ...
  const openEditDialog = (rowData) => {
    ...
    if (typeof rowData.file_url === "string") {
      const fullUrl = `https://randusanga-kulonbackend-production-fa8c.up.railway.app/${rowData.file_url}`;
