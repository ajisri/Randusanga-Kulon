...
const Sejarah = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://ds-randusanga-kulon.osc-fr1.scalingo.io/sejarah",
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosJWT.post(
        "https://ds-randusanga-kulon.osc-fr1.scalingo.io/csejarah",
        formData,
        {
          headers: {
      ...
      await mutate("https://ds-randusanga-kulon.osc-fr1.scalingo.io/sejarah");
