...
const Geografix = () => {
  ...
  const {
    ...
    "https://randusanga-kulon-ds.osc-fr1.scalingo.io//batawilayahpengunjung",
    fetcher
  );
  ...
  const {
    ...
    "https://randusanga-kulon-ds.osc-fr1.scalingo.io//orbitasipengunjung",
    fetcher
  );
  const {
    data: jenisLahanData,
    ...
    "https://randusanga-kulon-ds.osc-fr1.scalingo.io//jenislahanpengunjung",
    fetcher
  );
  const {
    ...
    "https://randusanga-kulon-ds.osc-fr1.scalingo.io//potensiwisatapengunjung",
    fetcher
  );
