...
const Geografix = () => {
  ...
  const {
    ...
    "https://api.desarandusangakulon.com/batawilayahpengunjung",
    fetcher
  );
  ...
  const {
    ...
    "https://api.desarandusangakulon.com/orbitasipengunjung",
    fetcher
  );
  const {
    data: jenisLahanData,
    ...
    "https://api.desarandusangakulon.com/jenislahanpengunjung",
    fetcher
  );
  const {
    ...
    "https://api.desarandusangakulon.com/potensiwisatapengunjung",
    fetcher
  );
