...
const OrbitasiDesa = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://randusanga-kulon.osc-fr1.scalingo.io/orbitasi",
    fetcher
  );
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://randusanga-kulon.osc-fr1.scalingo.io/orbitasi/${currentData.uuid}`,
          formData
        );
        toast.current.show({
          severity: "success",
        ...
        await axiosJWT.post(
          "https://randusanga-kulon.osc-fr1.scalingo.io/corbitasi",
          formData
        );
        toast.current.show({
          severity: "success",
      ...
      await mutate("https://randusanga-kulon.osc-fr1.scalingo.io/orbitasi");
      resetForm();
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://randusanga-kulon.osc-fr1.scalingo.io/orbitasi/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
