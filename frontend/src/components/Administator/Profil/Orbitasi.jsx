...
const OrbitasiDesa = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://api.desarandusangakulon.com/orbitasi",
    fetcher
  );
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://api.desarandusangakulon.com/orbitasi/${currentData.uuid}`,
          formData
        );
        toast.current.show({
          severity: "success",
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/corbitasi",
          formData
        );
        toast.current.show({
          severity: "success",
      ...
      await mutate("https://api.desarandusangakulon.com/orbitasi");
      resetForm();
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/orbitasi/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
