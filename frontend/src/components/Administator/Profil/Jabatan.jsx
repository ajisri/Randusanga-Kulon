...
const Jabatan = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://randusanga-kulon-ds.osc-fr1.scalingo.io//jabatan",
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.put(
          `https://randusanga-kulon-ds.osc-fr1.scalingo.io//ujabatan/${currentData.uuid}`,
          data,
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://randusanga-kulon-ds.osc-fr1.scalingo.io//cjabatan",
          data,
          {
            headers: {
              "Content-Type": "application/json",
      ...
      await mutate("https://randusanga-kulon-ds.osc-fr1.scalingo.io//jabatan");
      resetForm();
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://randusanga-kulon-ds.osc-fr1.scalingo.io//jabatan/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
  ...
  const handleKehadiranUpdate = async (rowData, statusBaru) => {
    try {
      ...
      await axiosJWT.put(
        `https://randusanga-kulon-ds.osc-fr1.scalingo.io//ujabatanhadir/${rowData.uuid}`,
        {
