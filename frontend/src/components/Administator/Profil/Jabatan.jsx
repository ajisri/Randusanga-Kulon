...
const Jabatan = () => {
  ...
  const { data, error, isLoading } = useSWR(
    "https://api.desarandusangakulon.com/jabatan",
    fetcher
  );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.put(
          `https://api.desarandusangakulon.com/ujabatan/${currentData.uuid}`,
          data,
          {
            headers: {
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/cjabatan",
          data,
          {
            headers: {
              "Content-Type": "application/json",
      ...
      await mutate("https://api.desarandusangakulon.com/jabatan");
      resetForm();
    ...
    if (window.confirm("Are you sure you want to delete this data?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/jabatan/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
  ...
  const handleKehadiranUpdate = async (rowData, statusBaru) => {
    try {
      ...
      await axiosJWT.put(
        `https://api.desarandusangakulon.com/ujabatanhadir/${rowData.uuid}`,
        {
