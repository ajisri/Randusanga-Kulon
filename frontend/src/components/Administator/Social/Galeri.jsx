...
const Galeri = () => {
  ...
  const {
    ...
    error,
    isLoading,
  } = useSWR("https://api.desarandusangakulon.com/galeri", fetcher);
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://api.desarandusangakulon.com/galeri/${currentGaleri.uuid}`,
          dataToSend,
          {
        ...
        await axiosJWT.post(
          "https://api.desarandusangakulon.com/cgaleri",
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
      ...
      await mutate("https://api.desarandusangakulon.com/galeri");
      resetForm();
      setDialogVisible(false);
    } catch (error) {
      handleError(error);
  ...
  const editGaleri = (galeri) => {
    ...
    const fileUrl = galeri.file_url
      ? `https://api.desarandusangakulon.com/${galeri.file_url}`
      : null;
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://api.desarandusangakulon.com/galeri/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
