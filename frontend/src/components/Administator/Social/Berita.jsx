...
const Berita = () => {
  ...
  const {
    ...
    error,
    isLoading,
  } = useSWR("https://randusanga-kulon.osc-fr1.scalingo.io/berita", fetcher);
    ...
    try {
      ...
      if (isEditMode) {
        await axiosJWT.patch(
          `https://randusanga-kulon.osc-fr1.scalingo.io/berita/${currentBerita.uuid}`,
          dataToSend,
          {
        ...
        await axiosJWT.post(
          "https://randusanga-kulon.osc-fr1.scalingo.io/cberita",
          dataToSend,
          {
            headers: { "Content-Type": "multipart/form-data" },
          }
      ...
      await mutate("https://randusanga-kulon.osc-fr1.scalingo.io/berita");
      resetForm();
      setDialogVisible(false);
    } catch (error) {
      handleError(error);
    ...
    if (window.confirm("Are you sure you want to delete this record?")) {
      try {
        await axiosJWT.delete(
          `https://randusanga-kulon.osc-fr1.scalingo.io/berita/${uuid}`
        );
        toast.current.show({
          severity: "success",
          summary: "Success",
