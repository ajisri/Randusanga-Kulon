...
const Modalt = () => {
  ...
  const { data: produkhukumData, error: produkhukumError } = useSWR(
    "https://api.desarandusangakulon.com/produk_hukump",
    fetcher
  );
  ...
  const { data: allapbdData, error: allapbdError } = useSWR(
    "https://api.desarandusangakulon.com/allapbdp",
    fetcher
  );
  ...
  const { data: allankorData } = useSWR(
    "https://api.desarandusangakulon.com/ankorp",
    fetcher
  );
                ...
                >
                  ...
                  <Column
                    ...
                    body={(rowData) => {
                      ...
                      return (
                        <a
                          href={`https://api.desarandusangakulon.com/download/${fileName}`} // Mengarahkan ke controller di backend
                          download
